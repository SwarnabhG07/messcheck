    ...
    <div className="min-h-screen bg-[#f0f4f8] flex items-center justify-center px-4 font-sans">
      ...
      <div className="relative w-full max-w-105">
        ...
        <div className="text-center mb-5">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-amber-600 text-white mb-3 shadow-lg shadow-amber-600/20">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              <Checkbox id="remember" className="rounded border-gray-300 data-[state=checked]:bg-amber-600 data-[state=checked]:border-amber-600" />
              <Label
                htmlFor="remember"
